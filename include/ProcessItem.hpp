...
#ifndef SIMPLETHREADMANAGER_PROCESSITEM_H
#define SIMPLETHREADMANAGER_PROCESSITEM_H
...
class ProcessItem
{
    ...
    public:
        ProcessItem(std::string id,  std::shared_ptr<IProcess> process, std::initializer_list<std::string> dependencies, long priorityLevel)
...
#endif //SIMPLETHREADMANAGER_PROCESSITEM_H
